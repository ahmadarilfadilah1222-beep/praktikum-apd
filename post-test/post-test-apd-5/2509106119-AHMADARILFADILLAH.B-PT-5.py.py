...
mobil_list = [
    ["KT1234AA", "Toyota Alphard", 1500000, "Tersedia"],
    ["DA5678BB", "BMW i8", 2500000, "Tersedia"],
    ["KH8765CC", "Mercedes Benz S-Class", 2800000, "Tersedia"],
    ["KB4321DD", "Range Rover Evoque", 2000000, "Tersedia"],
    ["KU9999EE", "Porsche Cayenne", 3000000, "Tersedia"]
]
...
while True:
    ...
    print("2. Register")
    print("3. Keluar")
    menu_awal = input("Pilih menu (1/2/3): ").strip()
